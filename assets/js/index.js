$(function () {
    ...
    new Chart(document.getElementById("chart5"), {
        ...
        type: 'doughnut',
        data: {
            labels: ["Github", "Latest"],
            datasets: [{
                label: "Device Users",
                backgroundColor: ["#3461ff", "#8ea8fd"], 
                data: [github, latest]
            }]
        },
        options: {
...
function callPopup() {
    $(".form-popup .close").on("click", function () { $(this).closest(".popup-wrap").removeClass("show") }), $(document).mouseup(function (e) {
        var t = $(".form-popup");
...
screen.lockOrientation("portrai");